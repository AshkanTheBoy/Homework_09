package Labs;
/*
Дана последовательность целых чисел. Если все числа
являются четными - поменять местами противоположные элементы.
В противном случае, нечетные элементы последовательности обнулить.
*/
